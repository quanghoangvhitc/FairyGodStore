...
namespace FairyGodStore.Migrations
{
    ...
    [Migration("20230320101921_FairyGodStoreV4")]
    partial class FairyGodStoreV4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FairyGodStore.Models.BookChapter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FairyGodStore.Models.BookContent", b =>
                {
                    b.HasOne("FairyGodStore.Models.BookChapter", "bookchapter")
                        .WithOne("bookcontent")
                        .HasForeignKey("FairyGodStore.Models.BookContent", "BookChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
